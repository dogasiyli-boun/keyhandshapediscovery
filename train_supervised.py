...
def parseArgs(argv):
    ...
    param01 = {"paramName": "modelName", "possibleValues": "{'resnet18','vgg16','alexnet'}",
...
def get_create_folders(params_dict):
    ...
    results_dir = os.path.join(base_dir, 'sup', 'results_' + params_dict["modelName"])
    models_dir = os.path.join(base_dir, 'sup', 'models_' + params_dict["modelName"])
