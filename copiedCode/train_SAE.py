...
batch_size = 16
weight_of_regularizer = 0.005 # sparsity parametresi (a trade-off between reconstruction vs clustering)
epochs = 1000 
...
#%%
model = Sequential()
model.add(Dense(posterior_dim,activity_regularizer=neg_l2_reg, input_shape=(data_dim,),name='encoder_layer'))
